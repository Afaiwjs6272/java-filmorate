...
public class UserRepository extends BaseRepository<User> implements UserStorage {
    ...
    public UserRepository(JdbcTemplate jdbc, RowMapper<User> mapper, @Autowired FriendRepository friendshipRepository) {
        super(jdbc, mapper);
    ...
    private Collection<User> loadFriends(Collection<User> users) {
        if (!users.isEmpty()) {
            Collection<Friend> friendshipCollection = friendshipRepository.getAll();
            for (User user : users) {
